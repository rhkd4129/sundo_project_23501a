...
@Slf4j
public class System2Interceptor extends EgovAbstractServiceImpl implements HandlerInterceptor {
	
	public System2Interceptor() {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        log.info("실시간 수문정보 관리시스템 {}: ", system_category.equals("2"));
        if (!system_category.equals("2") && !system_category.equals("1")) {
            //  헤더의 내용 중 요청 이전의 URL을 String으로 받음.
            String referer = request.getHeader("Referer");
            String alertMessage = "실시간 수문정보 관리시스템 권한이 없습니다.";
