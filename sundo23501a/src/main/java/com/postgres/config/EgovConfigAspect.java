...
import com.postgres.cmmn.AopExceptionTransfer;
import com.postgres.cmmn.EgovSampleExcepHndlr;
import com.postgres.cmmn.EgovSampleOthersExcepHndlr;
...
public class EgovConfigAspect {
	/* @EnableAspectJAutoProxy: AspectJ를 사용한 AOP를 활성화 */
	@Autowired
