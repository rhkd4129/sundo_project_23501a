	...
	<div class="container-fluid">		
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<ul class="nav nav-pills">
				<li class="nav-item">
					<a class="nav-link px-2 link-light" aria-current="page" href="#">일반 사용자</a>
				</li>
			</ul>
			
			<!-- 회원가입 -->
			<button class="btn btn-secondary" onclick="location.href='/user_join_write'">
			...
			<!-- 로그인 -->
			<button class="btn btn-secondary" onclick="location.href='/user_login'">
