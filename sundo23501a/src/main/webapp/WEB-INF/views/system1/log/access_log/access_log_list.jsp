				...
				<div id="idFrameList">
					<div class="container-fluid">
						<table width="100%" style="height:45px">
							<tr>
								<td style="vertical-align:top"><span class="apptitle">접속 이력</span></td>
								<td align="right">									
								</td>
							</tr>
						</table>
						...
						<table width="100%" style="margin-bottom:5px">
							<tr>
								<!-- <td width="100">
									<button type="button" class="btn btn-dark btn-sm" onclick="callAction('write','access_log_write')">작성</button>
								</td>
								<td width="200">
								...
								<td width="*" style="text-align:right">
									<c:if test="${not empty keyword}">								
										<a href="access_log_list"><img src="/images/btn_icon_delete2.png" width="18" height="19" style="vertical-align:bottom"></a> 
						...
						<table class="table table-hover">
							...
							<c:forEach items="${boardList}" var="board">
								<tr>
									<td>${board.rn}</td>
									<td>${board.program_url}</td>
									<td>${board.user_name}</td>
									<td><fmt:formatDate value="${board.access_datetime}" type="date" pattern="yyyy-MM-dd hh:mm:ss"/></td>
									<td>${board.ip}</td>
