		...
		$.ajax({
			...
			success	: function(data) {
				...
				for (var i = obj.startPage; i <= obj.endPage; i++) {
                    ...
                    pagingStr += '" onclick="searchAction(' + i + ')"><div class="page-link">' + i + '</div></div>';
				}
				...
				<td>
					<div style="padding:10px 0px;text-align:center">
						<div class="btn-group btn-group tapBtn">
							...
							<button type="button" id="actionBtn" class="btn btn-dark" onclick="location.href='/action_report_list'">조치 결과 보고서</button>
						</div>
					</div>
				</td>
			</tr>
		...
		<div class="searchbox">
			<table>
				<tr>
					...
					<th style="width:120px;text-align:right;font-weight:bold;">조치/복구 일자</th>
					<td><input type="date" name="action_date" id="action_date" class="form-control"></td>
		...
		<div>
			...
			<div id="paging" class="pagination justify-content-center">
				...
				<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
					...
					onclick="location.href='action_report_list?currentPage=${i}'">
