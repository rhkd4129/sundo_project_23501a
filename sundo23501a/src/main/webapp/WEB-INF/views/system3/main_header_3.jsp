...
<nav class="navbar navbar-expand-md navbar-dark fixed-top pms-bg-dark">
	<div class="container-fluid">		
		<a class="navbar-brand" style="margin-left:10px" href="/water_resourcesList"><b style="color: white;">수자원 시설물 관리시스템</b></a>

		<div style="margin-left: 3%">
			<span class="sub-list" id="sub-list-1" onclick="location.href='/water_resourcesList'"><b style="color: white;">점검결과작성</b></span>
			<span class="sub-list" id="sub-list-2" onclick="location.href='/selectCheckReportList'"><b style="color: white;">점검이력조회</b></span>
			<span class="sub-list" id="sub-list-3" onclick="location.href='/chart'"><b style="color: white;">점검이력통계</b></span>
			<span class="sub-list" id="sub-list-4" onclick="location.href='/error_report_list'"><b style="color: white;">고장/조치결과보고</b></span>
		</div>
