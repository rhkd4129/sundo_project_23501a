...
<nav class="navbar navbar-expand-md navbar-dark fixed-top pms-bg-dark">
	<div class="container-fluid">		
		...
		<div style="margin-left: 4%">
			<button class="btn btn-dark" onclick="goto('/main')">
				<a style="margin-left:10px" href="/water_resourcesList"><b>점검결과작성</b></a>
			</button>

			<button class="btn btn-dark" onclick="goto('/main')">
				<a style="margin-left:10px" href="/selectCheckReportList"><b>점검이력조회</b></a>
			</button>


			<button class="btn btn-dark" onclick="goto('/main')">
				<a style="margin-left:10px" href="/main"><b>점검이력통계</b></a>
			</button>

			<button class="btn btn-dark" onclick="goto('/main')">
				<a style="margin-left:10px" href="/action_report_list"><b>고장/조치결과보고</b></a>
			</button>
