...
<body>
	...
	<div class="container">
		...
		<div style="margin-top:20px">
			...
			<h5><b>관측소명 : <font class="text-info">${rainFallList.get(0).observe_post}</font></b></h5>
			<h6><b>(단위:mm)</b></h6>
			...
			<div id="paging" class="pagination pagination-sm justify-content-center">
			    ...
			    <c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
			        ...
			        onclick="location.href='/time_find_R?currentPage=${i}&river_code=${rainFallList.get(0).river_code}'">
