...
<body>
	...
	<br>
	<div class="container">
		<input type="hidden" name="river_code" id="river_code" value="${waterLevelStat.river_code}">
		...
		<div class="searchbox" style="margin-top:10px">
			<table style="margin:5px 30px">
				<tr>
					<th width="100"><span class="sub-tab" id="sub-tab-1"><a href="/time_chart_list?river_code=${waterLevelStat.river_code}">수위정보</a></span></th>
					<th width="100"><span class="sub-tab" id="sub-tab-2"><a href="/time_chart_list_R?river_code=${waterLevelStat.river_code}">강우량정보</a></span></th>
					<th width="100"><span class="sub-tab" id="sub-tab-3"><a href="/time_chart_list_F?river_code=${waterLevelStat.river_code}">우량정보</a></span></th>
					<%-- <th width="100"><span class="sub-tab" id="sub-tab-4"><a href="/time_chart_list_F?river_code=${waterLevelStat.river_code}">수문정보</a></span></th> --%>
				</tr>
			</table>
		</div>
		
		<div style="margin-top:20px">
			<input type="hidden" name="river_code" value="${waterLevelStat.river_code}">
			<span class="apptitle">시자료(수위)</span>
			<h5><b>관측소명 : <font class="text-info">${waterLevelStat.observe_post}</font></b></h5>
			<h6><b>(단위:mm)</b></h6>
