...
<nav class="navbar navbar-expand-md navbar-dark fixed-top pms-bg-dark">
	<div class="container-fluid">		
		<a class="navbar-brand" style="margin-left:10px" href="/realTimeSystem/layer"><b>실시간 수문정보 관리시스템</b></a>

		<div style="margin-left: 3%">
			<button type="button"  id="sub-map"  class="btn btn-sm btn-secondary" onclick="location.href='/realTimeSystem/layer'"><b>지도</b></button>
			<button type="button"  id="sub-list" class="btn btn-sm btn-light" onclick="location.href='/observation_find'"><b>목록</b></button>
		</div>
		
		<div style="margin-left: 2%">
			<span class="sub-list" id="sub-list-1" onclick="location.href='/observation_find'"><b>관측소</b></span>
			<span class="sub-list" id="sub-list-2" onclick="location.href='/waterResourcesList'"><b>수자원</b></span>
		</div>
