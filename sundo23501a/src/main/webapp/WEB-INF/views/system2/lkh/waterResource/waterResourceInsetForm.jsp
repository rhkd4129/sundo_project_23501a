...
<head>
<meta charset="UTF-8">
<title>실시간 수문정보 관리시스템 - 수자원 등록</title>
<style>
header {
	height: 55px;
}
		...
		<div class="card" style="padding:30px">
			<form action ="waterResourcesInsert" method="post">
				...
				<table>
					<tr>
						<th>시설물 코드</th>
						<td colspan="3"><input type="text" name="facility_code" class="form-control"></td>
					</tr>
					<tr>
						<th>시설물 종류</th>
						<td>
					...
					<tr>
						<th>주소</th>
						<td colspan="3">
							<input type="text" name="facility_addr" class="form-control">
						</th>
					</tr>
				</table>
