...
<nav class="navbar navbar-expand-md navbar-dark fixed-top pms-bg-dark">
	<div class="container-fluid">		
		<button class="btn btn-dark" onclick="goto('/main')">
			<a class="navbar-brand" style="margin-left:10px" href="/main"><b>실시간 수문정보 관리시스템</b></a>
		</button>

		<div style="margin-left: 3%">
			<button type="button"  class="btn btn-sm btn-dark " onclick="location.href='/realTimeSystem/layer' ">지도</button>
			<button type="button"  class="btn btn-sm btn-dark " onclick="location.href='/waterResourcesList' ">목록</button>

		</div>

		<div>
			<button type="button"  class="btn btn-sm btn-dark " onclick="location.href='/observation_find' ">관측소</button>
			<button type="button"  class="btn btn-sm btn-dark " onclick="location.href='/waterResourcesList' ">수자원</button>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<c:if test="${userInfo.system_category == '1'}">
				<!-- 실시간 수문정보 관리시스템 -->
				<button class="btn btn-dark" onclick="goto('observation_main')">
				...
				<!-- 수자원 시설물 관리시스템 -->
				<button class="btn btn-dark" onclick="goto('water_main')">
